      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="text-right mt-1">
                <Link
                  to="/forgot-password"
                  className="text-sm text-golden-dark hover:underline"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="text-center">
              ...
              <Link
                to="/register"
                className="text-golden-dark hover:underline font-medium"
              >
                Register!
              </Link>
            </div>
          ...
          <div className="mt-8 text-xs text-gray-600 text-center">
            <p className="mb-2">
              By registering an account on Editorial Manager, you acknowledge
              that your personal information will be processed in accordance
              with PLOS's Privacy Policy and agree to PLOS's Terms of Use.
            </p>
            <p>
              PLOS requires an ORCID ID for all corresponding authors and
              encourages all users to have one. To register for an ORCID ID
              and/or link your ID to your Editorial Manager account, click the
              green iD button. See this quick video tutorial for more
              information.
            </p>
          </div>
        </div>
